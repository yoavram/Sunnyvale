...
\begin{aligned}
\gamma_1 x_1' &= (1-m) x_1^s + c m x_2^s, \quad \gamma_1 = (1-m) + c m, \\
\gamma_2 x_2' &= m x_1^s + c (1-m) x_2^s, \quad \gamma_2 = m + c (1-m),
\end{aligned}
\end{equation}
where $0 \le m \le 1/2$ is the migration rate, i.e. the fraction of the population that is replaced by migrants; $c>0$ is the relative size of deme 2 compared to deme 1 (at least where migration is concerned); and $\gamma_j$ is a normalizing factor.
