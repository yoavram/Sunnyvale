...
Nevertheless, if we assume that social learning can be affected by weather, food availability, population density, or even political atmosphere, then it is reasonable that the mode and rate of transmission will fluctuate over time. 
...
We find that a phenotypic polymorphism cannot be maintained unless fluctuations in the mode of transmission are very small and only weakly correlated with fluctuations in selection.
